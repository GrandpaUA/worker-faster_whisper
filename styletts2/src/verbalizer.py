# Verbalizer з HF space patriotyk/styletts2-ukrainian (verbatim, без змін):
# числа/акроніми → словесна форма. StyleTTS2 без нього не читає цифри.
# Модель: skypro1111/m2m100-ukr-verbalization-ct2 (ctranslate2, CPU int8).
import os
import time
import ctranslate2
